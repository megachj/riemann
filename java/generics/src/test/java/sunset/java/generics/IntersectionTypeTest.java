...
public class IntersectionTypeTest {
    ...
    public void usage1_markerInterface() {
        ...
        IntersectionType.printFuncResult((Function<Integer, Integer> & LinearFuncMarker) x -> 2 * x + 1, 1); // (Function<Integer, Integer> & LinearFuncMarker) is a Function<Integer, Integer>
